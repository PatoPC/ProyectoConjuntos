...
(ID_CATALOGOPADRE,NIVEL_CATALOGO, NOMBRE_CATALOGO, CODIGO_CATALOGO, DESCRIPCION, EDITABLE, ESTADO, TIENE_VIGENCIA, FECHA_CREACION, FECHA_MODIFICACION, USUARIO_CREACION, USUARIO_MODIFICACION, DATO_ADICIONAL)
VALUES( (select ID_CATALOGO from Catalogo_Conjunto.dbo.CATALOGO where CODIGO_CATALOGO ='GCONJT'), 
2, 'Proveedor', 'MPDENPRV', '', 0, 1, 0, getdate(), getdate(), 'admin', 'admin','/C_Proveedor/AdministrarProveedor');


SELECT *
from Catalogo_Conjunto.dbo.CATALOGO c 
where c.CODIGO_CATALOGO ='TIDENPRV'
...
(ID_CATALOGOPADRE,NIVEL_CATALOGO, NOMBRE_CATALOGO, CODIGO_CATALOGO, DESCRIPCION, EDITABLE, ESTADO, TIENE_VIGENCIA, FECHA_CREACION, FECHA_MODIFICACION, USUARIO_CREACION, USUARIO_MODIFICACION)
VALUES( (select ID_CATALOGO from Catalogo_Conjunto.dbo.CATALOGO where CODIGO_CATALOGO ='TPIDENT'), 
0, 'RUC', 'TIDENRUC', '', 0, 1, 0, getdate(), getdate(), 'admin', 'admin');
...
DELETE from Condominios.dbo.DETALLE_COMPROBANTE_PAGO; 
DELETE from Condominios.dbo.COMPROBANTE_PAGO;
...
SELECT *
from Condominios.dbo.ADEUDOS a 
where a.ID_ADEUDOS ='8e18c6e9-ab96-478a-aa1a-653996bf0a91'

SELECT *
from Condominios.dbo.ADEUDOS a 
where a.ID_DEPARTAMENTO ='C3F05ADD-D324-44BA-BFE2-E3D59EDB6B60'


SELECT *
from Condominios.dbo.DETALLE_COMPROBANTE_PAGO d
where d.ID_TABLA_DEUDA  ='8e18c6e9-ab96-478a-aa1a-653996bf0a91'


SELECT *
from Catalogo_Conjunto.dbo.CATALOGO c 
where c.ID_CATALOGO ='b7e41748-4da2-4da4-be89-dc768baedf48'

SELECT *
from CatalogoGeneral.dbo.CATALOGO c 
where c.DATO_ADICIONAL = 'Provincia'
or c.DATO_ADICIONAL = 'Cantones'

UPDATE CatalogoGeneral.dbo.CATALOGO set ID_CATALOGOPADRE = 'B7E41748-4DA2-4DA4-BE89-DC768BAEDF48' 
where DATO_ADICIONAL = 'Provincia'


INSERT INTO Catalogo_Conjunto.dbo.CATALOGO
(ID_CATALOGO, NIVEL_CATALOGO, NOMBRE_CATALOGO, CODIGO_CATALOGO, DESCRIPCION, EDITABLE, ESTADO, TIENE_VIGENCIA, FECHA_CREACION, FECHA_MODIFICACION, USUARIO_CREACION, USUARIO_MODIFICACION)
SELECT ID_CATALOGO, NIVEL_CATALOGO, NOMBRE_CATALOGO, CODIGO_CATALOGO, DESCRIPCION, EDITABLE, ESTADO, TIENE_VIGENCIA, FECHA_CREACION, FECHA_MODIFICACION, USUARIO_CREACION, USUARIO_MODIFICACION
FROM CatalogoGeneral.dbo.CATALOGO c
WHERE (c.CODIGO_CATALOGO = 'ECUADR')

-- Paso 1: Insertar los registros que no tienen ID_CATALOGOPADRE
INSERT INTO Catalogo_Conjunto.dbo.CATALOGO
(ID_CATALOGO, NIVEL_CATALOGO, NOMBRE_CATALOGO, CODIGO_CATALOGO, DESCRIPCION, EDITABLE, ESTADO, TIENE_VIGENCIA, FECHA_CREACION, FECHA_MODIFICACION, USUARIO_CREACION, USUARIO_MODIFICACION)
SELECT ID_CATALOGO, NIVEL_CATALOGO, NOMBRE_CATALOGO, CODIGO_CATALOGO, DESCRIPCION, EDITABLE, ESTADO, TIENE_VIGENCIA, FECHA_CREACION, FECHA_MODIFICACION, USUARIO_CREACION, USUARIO_MODIFICACION
FROM CatalogoGeneral.dbo.CATALOGO c
...
-- Paso 2: Insertar los registros que tienen ID_CATALOGOPADRE
INSERT INTO Catalogo_Conjunto.dbo.CATALOGO
(ID_CATALOGO, ID_CATALOGOPADRE, NIVEL_CATALOGO, NOMBRE_CATALOGO, CODIGO_CATALOGO, DESCRIPCION, EDITABLE, ESTADO, TIENE_VIGENCIA, FECHA_CREACION, FECHA_MODIFICACION, USUARIO_CREACION, USUARIO_MODIFICACION)
SELECT ID_CATALOGO, ID_CATALOGOPADRE, NIVEL_CATALOGO, NOMBRE_CATALOGO, CODIGO_CATALOGO, DESCRIPCION, EDITABLE, ESTADO, TIENE_VIGENCIA, FECHA_CREACION, FECHA_MODIFICACION, USUARIO_CREACION, USUARIO_MODIFICACION
FROM CatalogoGeneral.dbo.CATALOGO c
WHERE c.DATO_ADICIONAL = 'Cantones'
AND c.ID_CATALOGOPADRE IS NOT NULL;
