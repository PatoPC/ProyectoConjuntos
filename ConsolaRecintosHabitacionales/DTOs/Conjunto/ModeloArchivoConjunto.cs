...
namespace DTOs.Conjunto
{
    public class ModeloArchivoConjunto
    {
        ...
        public string? Tipo_Identificación_Condomino { get; set; } = null;
        public string? Numero_Identificación_Condomino { get; set; } = null;
        ...
        public string? Tipo_Identificación_Propietario { get; set; } = null;
        public string? Numero_Identificación_Propietario { get; set; } = null;
