...
namespace APICondominios.Controllers
{
    ...
    public class API_AdeudoController : ControllerBase
    {
        ...
        public API_AdeudoController(IMapper mapper, IManageConjuntosCRUD<List<Adeudo>> cRUD_Condominio, IManagePersona condominio, IManageLogError logError, IManageAdeudo consultaAdeudo)
        {
            _mapper = mapper;
